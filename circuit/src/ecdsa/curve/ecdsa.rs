...
use crate::ecdsa::curve::curve_msm::msm_parallel;
use crate::ecdsa::curve::curve_types::{AffinePoint, Curve, CurveScalar, base_to_scalar};
...
mod tests {
    ...
    use crate::ecdsa::curve::ecdsa::{ECDSASecretKey, sign_message, verify_message};
